...
<body style="background-color: #FFFFFF; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
	<table class="nl-container" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #FFFFFF;">
		<tbody>
			<tr>
				<td>
					<table class="row row-1" align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #f8e9ff;">
						<tbody>
							<tr>
								<td>
									<table class="row-content stack" align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #4e73df; background-image: url('https://d1oco4z2z1fhwp.cloudfront.net/templates/default/7736/texture-dot.png'); background-repeat: no-repeat; color: #000000; width: 650px; margin: 0 auto;" width="650">
										<tbody>
											<tr class="reverse">
															...
															<tr>
																<td class="pad" style="width:100%;">
																	<div class="alignment" align="center" style="line-height:10px">
																		<div style="max-width: 325px;"><a href="http://www.example.com" target="_blank" style="outline:none" tabindex="-1"><img src="https://5400495e6a.imgdist.com/public/users/Integrators/BeeProAgency/1114889_1100379/kisspng-reset-button-icon-restart-png-free-download-5a75888d8ebb29.6889129515176521095846.png" style="display: block; height: auto; border: 0; width: 100%;" width="325" alt="Football Player" title="Football Player"></a></div>
																	</div>
																</td>
															</tr>
														</table>
															...
															<tr>
																<td class="pad">
																	<div style="color:#ffffff;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-size:14px;line-height:200%;text-align:left;mso-line-height-alt:28px;">
																		<p style="margin: 0; word-break: break-word;">Push the bottom below to reset your password, it will redirect you to a view where you can reset your password</p>
																	</div>
																</td>
															</tr>
														</table>
