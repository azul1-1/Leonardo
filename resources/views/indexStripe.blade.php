                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Collaborate with us!</h1>
                                    </div>
                                    ...
                                    <form action="{{url('stripeCheck')}}" method="POST">
    <input type="hidden" name="_token" value="{{csrf_token()}}">
    <button class="btn btn-primary btn-user btn-block" type="submit">Use stripe Checkout</button>
</form>
